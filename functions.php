...
require_once get_theme_file_path( './functions/add-editor-styles.php' ); /* GutenbergにCSSを適用 */
require_once get_theme_file_path( './functions/add-wp-block-menu.php' ); /* 管理画面のメニューをカスタム */
...
require_once get_theme_file_path( './functions/shortcode-embed-card.php' ); /* ショートコードにオリジナルのブログカードを登録 */
